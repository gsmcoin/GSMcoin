...
private slots:
    ...
    void on_BuyGSM_clicked();
    void on_SellGSMBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputGSM_textChanged(const QString &arg1);
    ...
    QString BuyGSM(QString OrderType, double Quantity, double Rate);
    QString SellGSM(QString OrderType, double Quantity, double Rate);
