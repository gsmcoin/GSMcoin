...
int nCoinbaseMaturity = 100; // 100 blocks for coins to mature
...
const string strMessageMagic = "GSMcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	else if (pindexBest->nHeight+1 >= 2001 && pindexBest->nHeight+1 <= 3000 ) 
    {
        nSubsidy = 600 * COIN;
    }
...
// GSMcoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GSMcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "2015 GSMcoin!";
        CTransaction txNew;
        txNew.nTime = 1423590555;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1423590555;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1409610;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x24a2ed865e99fb8353f1ae4b82834410e818b9f03e475c0a3c2d9c3fc940b8fa"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xcc, 0xdd, 0x77, 0x17 };
